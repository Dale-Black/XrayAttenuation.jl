# ============================================================================
# Element Data - NIST Standard Reference Database
# ============================================================================
# Data from NIST Physical Reference Data
# Z/A ratios, mean excitation energies (I), and standard densities

"""
Named tuple containing all 92 elements (Hydrogen through Uranium).
Access elements by name: Elements.Hydrogen, Elements.Gold, etc.
"""
const Elements = (
    ...
    Molybdenum = Element(42, "Mo", "Molybdenum", 0.43777, 424.0eV, 1.022E+01g / cm^3),
    Technetium = Element(43, "Tc", "Technetium", 0.43919, 428.0eV, 1.150E+01g / cm^3),
    ...
    Praseodymium = Element(59, "Pr", "Praseodymium", 0.41871, 535.0eV, 6.710E+00g / cm^3),
    Neodymium = Element(60, "Nd", "Neodymium", 0.41597, 546.0eV, 6.900E+00g / cm^3),
    Promethium = Element(61, "Pm", "Promethium", 0.42094, 560.0eV, 7.220E+00g / cm^3),
    ...
    Gadolinium = Element(64, "Gd", "Gadolinium", 0.40699, 591.0eV, 7.900E+00g / cm^3),
    Terbium = Element(65, "Tb", "Terbium", 0.40900, 614.0eV, 8.229E+00g / cm^3),
    Dysprosium = Element(66, "Dy", "Dysprosium", 0.40615, 628.0eV, 8.550E+00g / cm^3),
    ...
    Protactinium = Element(91, "Pa", "Protactinium", 0.39388, 878.0eV, 1.537E+01g / cm^3),
